  ...
  return (
    <div>
      <div className="h-[380px]">
        {data?.branches.map(({ fullAddress, id, address, cityId, city }) => (
          <Branch
        ...
        <div className="flex items-center gap-1">
          {active <= 3 && (
            <>
              ...
              <IconButton
                {...getItemProps(Math.ceil(data?.count / data?.pageSize))}
              >
          ...
          {active > 3 && active < Math.ceil(data?.count / data?.pageSize) && (
            <>
              <IconButton {...getItemProps(active - 2)}>
                {active - 2}
              </IconButton>
              <IconButton {...getItemProps(active - 1)}>
                {active - 1}
              </IconButton>
